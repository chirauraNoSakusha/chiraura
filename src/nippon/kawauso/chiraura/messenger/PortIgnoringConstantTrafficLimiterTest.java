 ...
 */
public class PortIgnoringConstantTrafficLimiterTest {

    private static final Logger LOG = Logger.getLogger(PortIgnoringConstantTrafficLimiterTest.class.getName());

    /**
     * 初期化
     */
    public PortIgnoringConstantTrafficLimiterTest() {
    ...
    private static void something(final long duration, final long sizeLimit, final int countLimit, final int numOfThreads, final int numOfAddresses,
        ...
        final TrafficLimiter controller = new PortIgnoringConstantTrafficLimiter(duration, sizeLimit, countLimit, penalty);
