...
public final class WriteCachingStorageTest {
    ...
    public void testRandom() throws Exception {
        ...
        final Storage instance = new WriteCachingStorage(new FileStorage32(this.root, this.chunkSizeLimit, this.directoryBitSize),
    ...
    public void testClear() throws Exception {
        ...
        try (final Storage instance1 = new FileStorage32(root1, this.chunkSizeLimit, this.directoryBitSize);
                final Storage instance2 = new WriteCachingStorage(new FileStorage32(root2, this.chunkSizeLimit, this.directoryBitSize),
                        (int) (this.factor * numOfChunks))) {
