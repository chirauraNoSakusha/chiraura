...
final class OrderingBoardChunk extends SkeletalChunk implements Mountain, Content {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        Entry entry = new Entry(System.currentTimeMillis(), System.currentTimeMillis(), System.currentTimeMillis() / 1_000L, "ああああうえ", 1);
        ...
        entry = new Entry(System.currentTimeMillis(), System.currentTimeMillis(), System.currentTimeMillis() / 1_000L, "てすと", 1);
        System.out.println("add " + entry);
        instance.patch(entry);
        System.out.println("[" + instance.toNetworkString() + "]");
        ...
        entry = new Entry(System.currentTimeMillis(), System.currentTimeMillis() - 10_000, System.currentTimeMillis() / 1_000L, "勝ったぜ", 1);
        System.out.println("add " + entry);
        instance.patch(entry);
        System.out.println("[" + instance.toNetworkString() + "]");
