 ...
 */
final class BoardChunk extends SkeletalChunk implements Mountain, Content {

    /**
     * 識別子。
     * @author chirauraNoSakusha
     */
    static final class Id implements Chunk.Id<BoardChunk> {
        ...
        @Override
        public Class<BoardChunk> getChunkClass() {
            return BoardChunk.class;
        }
        ...
        public String toString() {
            return (new StringBuilder(BoardChunk.class.getSimpleName())).append('.').append(this.getClass().getSimpleName())
     ...
     * @author chirauraNoSakusha
     */
    static final class Entry implements Mountain.Dust<BoardChunk> {
        ...
        @Override
        public Class<BoardChunk> getMountainClass() {
            return BoardChunk.class;
        }
    ...
    @Override
    public BoardChunk copy() {
        return new BoardChunk(this.id, new HashMap<>(this.threadToEntry), new TreeMap<>(this.dateToEntry), this.entrySize, this.updateDate, this.notHashed,
                this.hashValue);
    }
    ...
    static BytesConvertible.Parser<BoardChunk> getParser() {
        return new BytesConvertible.Parser<BoardChunk>() {
            @Override
            public int fromStream(final InputStream input, final int maxByteSize, final List<? super BoardChunk> output) throws MyRuleException, IOException {
                ...
                final BoardChunk instance = new BoardChunk(id.get(0));
    ...
    public boolean equals(final Object obj) {
        if (this == obj) {
            return true;
        } else if (!(obj instanceof BoardChunk)) {
            return false;
        }
    ...
    public boolean baseEquals(final Mountain o) {
        if (this == o) {
            return true;
        } else if (!(o instanceof BoardChunk)) {
            return false;
        }
        final BoardChunk other = (BoardChunk) o;
